 ...
 */
package org.aksw.geostats.util;
...
public final class Configuration {
  ...
  private void initializeParameters(Properties properties) {
     ...
     * changes dg
     */
    if (!UtilsLib.isNullOrEmpty(properties.getProperty("administrativeDistrict"))) {
    	administrativeDistrict = properties.getProperty("administrativeDistrict");
    }
    if (!UtilsLib.isNullOrEmpty(properties.getProperty("state"))) {
    	state = properties.getProperty("state");
    }
    if (!UtilsLib.isNullOrEmpty(properties.getProperty("country"))) {
